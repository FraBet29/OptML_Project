...
@register_optimizer('adasub')
class FairseqAdasub(FairseqOptimizer):
    """
    Adasub optimizer for fairseq.
    """

    def __init__(self, args, params):
        super().__init__(args)
        self._optimizer = Adasub(params, **self.optimizer_config)
    ...
    def add_args(parser):
        ...
        """
        parser.add_argument('--lr', type=float, metavar='LR', help='learning rate') # not sure about metavar
        parser.add_argument('--n_directions', type=int, metavar='ND', help='number of directions')
        parser.add_argument('--device', type=str, metavar='D', help='device')
    ...
    def optimizer_config(self):
        ...
        return {
            'lr': self.args.lr,
            'n_directions': self.args.n_directions,
